...
const DoctorSosPatientPage: React.FC = () => {
                        ...
                        <tr key={patient.id} className="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-800 dark:text-gray-200">
                          ...
                          <td className="py-2 px-4">
                           ...
                           <td className="py-2 px-4 space-x-2">
                                ...
                                <button onClick={() => navigate(`/doctor/sos-patients/edit-report/${patient.id}`)} className="bg-green-500 text-white text-sm py-1 px-3 rounded-md hover:bg-green-600">Edit</button>
                           </td>
                        </tr>
                      ))}
                    </tbody>
...
export default DoctorSosPatientPage;
