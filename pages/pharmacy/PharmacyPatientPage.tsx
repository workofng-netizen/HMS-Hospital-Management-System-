...
const PharmacyPatientPage: React.FC = () => {
            ...
            <main className="flex-grow p-6 bg-white dark:bg-gray-800 rounded-b-lg flex flex-col">
                ...
                <div className="mt-auto pt-4 border-t border-gray-200 dark:border-gray-700 flex justify-between items-center">
                    <div>
                        ...
                        <button disabled={!selectedPatient} onClick={() => selectedPatient && navigate(`/pharmacy/patients/edit-report/${selectedPatient}`)} className={`py-2 px-4 rounded-md ${selectedPatient ? 'bg-green-500 hover:bg-green-600 text-white' : buttonDisabledStyles}`}>
                            Edit Report
                        </button>
                    </div>
                    <DateTime />
...
export default PharmacyPatientPage;
