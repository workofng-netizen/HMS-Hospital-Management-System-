...
const EditPharmacyReportPage: React.FC = () => {
    ...
    const handleSave = () => {
        ...
        if (isSosPatient) {
            ...
            navigate('/pharmacy/sos-patients');
        } else {
    ...
    const handleCancel = () => {
        navigate(isSosPatient ? '/pharmacy/sos-patients' : '/pharmacy/patients');
    };
...
export default EditPharmacyReportPage;
