        ...
        <div className="flex flex-col h-full">
            ...
            <main className="flex-grow p-6 bg-white dark:bg-gray-800 rounded-b-lg flex flex-col">
                <div className="flex items-center mb-4">
                    ...
                    <button onClick={() => navigate('/patients/add')} className="ml-4 bg-primary text-white py-2 px-4 rounded-md hover:bg-primary-dark transition-colors flex items-center justify-center">
                ...
                <div className="mt-auto pt-4 border-t border-gray-200 dark:border-gray-700 flex justify-between items-center">
                    <div>
                        ...
                        <button disabled={!selectedPatient} onClick={() => selectedPatient && navigate(`/patients/edit/${selectedPatient}`)} className={`py-2 px-4 rounded-md ${selectedPatient ? 'bg-green-500 hover:bg-green-600 text-white' : buttonDisabledStyles}`}>
                            Edit Patient
                        </button>
                    </div>
                    <DateTime />
