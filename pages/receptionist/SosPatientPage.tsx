        ...
        <div className="flex flex-col h-full">
            ...
            <main className="flex-grow p-6 bg-white dark:bg-gray-800 rounded-b-lg flex flex-col">
                <div className="flex items-center mb-4">
                    ...
                    <button onClick={() => navigate('/sos-patients/add')} className="ml-4 bg-primary text-white py-2 px-4 rounded-md hover:bg-primary-dark transition-colors flex items-center justify-center">
                        ...
                        <tr key={patient.id} className="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-800 dark:text-gray-200">
                          ...
                          <td className="py-2 px-4">
                           ...
                           <td className="py-2 px-4 space-x-2">
                                <button onClick={() => navigate(`/sos-patients/report/${patient.id}`)} className="bg-green-500 text-white text-sm py-1 px-3 rounded-md hover:bg-green-600">View Report</button>
                                <button onClick={() => navigate(`/sos-patients/convert/${patient.id}`)} className="bg-blue-500 text-white text-sm py-1 px-3 rounded-md hover:bg-blue-600">Convert</button>
                           </td>
                        </tr>
                      ))}
                    </tbody>
